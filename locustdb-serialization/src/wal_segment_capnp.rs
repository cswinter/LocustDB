...
pub mod column {
  ...
  pub mod data {
    pub use self::Which::{F64,SparseF64,I64,String,Empty,SparseI64,Mixed};
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn set_mixed(&mut self, value: ::capnp::struct_list::Reader<'_,crate::wal_segment_capnp::any_val::Owned>) -> ::capnp::Result<()> {
        self.builder.set_data_field::<u16>(0, 6);
        ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
      }
      #[inline]
      pub fn init_mixed(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::wal_segment_capnp::any_val::Owned> {
        self.builder.set_data_field::<u16>(0, 6);
        ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(1), size)
      }
      #[inline]
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 126] = [
        ...
        ::capnp::word(0, 0, 0, 0, 3, 0, 1, 0),
        ::capnp::word(16, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(151, 179, 184, 144, 137, 45, 16, 204),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(14, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
        match index {
          ...
          6 => <::capnp::struct_list::Owned<crate::wal_segment_capnp::any_val::Owned> as ::capnp::introspect::Introspect>::introspect(),
          _ => panic!("invalid field index {}", index),
        }
      }
      pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
      ...
      pub static MEMBERS_BY_NAME : &[u16] = &[4,0,2,6,1,5,3];
    ...
    pub type WhichReader<'a,> = Which<::capnp::Result<::capnp::primitive_list::Reader<'a,f64>>,crate::wal_segment_capnp::column::data::sparse_f64::Reader<'a>,::capnp::Result<::capnp::primitive_list::Reader<'a,i64>>,::capnp::Result<::capnp::text_list::Reader<'a>>,crate::wal_segment_capnp::column::data::sparse_i64::Reader<'a>,::capnp::Result<::capnp::struct_list::Reader<'a,crate::wal_segment_capnp::any_val::Owned>>>;
    pub type WhichBuilder<'a,> = Which<::capnp::Result<::capnp::primitive_list::Builder<'a,f64>>,crate::wal_segment_capnp::column::data::sparse_f64::Builder<'a>,::capnp::Result<::capnp::primitive_list::Builder<'a,i64>>,::capnp::Result<::capnp::text_list::Builder<'a>>,crate::wal_segment_capnp::column::data::sparse_i64::Builder<'a>,::capnp::Result<::capnp::struct_list::Builder<'a,crate::wal_segment_capnp::any_val::Owned>>>;
...
pub mod any_val {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_value(self) -> crate::wal_segment_capnp::any_val::value::Reader<'a> {
      self.reader.into()
    }
  }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_value(self) -> crate::wal_segment_capnp::any_val::value::Builder<'a> {
      self.builder.into()
    }
    #[inline]
    pub fn init_value(mut self, ) -> crate::wal_segment_capnp::any_val::value::Builder<'a> {
  ...
  impl Pipeline  {
    pub fn get_value(&self) -> crate::wal_segment_capnp::any_val::value::Pipeline {
      ::capnp::capability::FromTypelessPipeline::new(self._typeless.noop())
    }
  }
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 26] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(130, 233, 40, 211, 127, 134, 31, 192),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::wal_segment_capnp::any_val::value::Owned as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[0];
    pub const TYPE_ID: u64 = 0xcc10_2d89_90b8_b397;
  }
  ...
  pub mod value {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 77] = [
        ...
        ::capnp::word(101, 110, 116, 46, 99, 97, 112, 110),
        ::capnp::word(112, 58, 65, 110, 121, 86, 97, 108),
        ::capnp::word(46, 118, 97, 108, 117, 101, 0, 0),
      ...
      pub const TYPE_ID: u64 = 0xc01f_867f_d328_e982;
    }
    pub enum Which<A0> {
      F64(f64),
      I64(i64),
